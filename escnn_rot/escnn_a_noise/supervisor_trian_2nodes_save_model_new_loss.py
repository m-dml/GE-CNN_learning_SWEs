...
fabric = L.Fabric(accelerator="gpu", devices="auto", strategy="ddp", num_nodes=1)   # num_nodes=2, devices is 2gpu per nodes, eg. 2 gpu on g022
...
#levanter
TRAIN_X_PATH = '/work/gg0028/g260202/generate_data_3/train_x_1.mat'
TRAIN_Y_PATH = '/work/gg0028/g260202/generate_data_3/train_y_1.mat'

VALIDATE_X_PATH = '/work/gg0028/g260202/generate_data_3/validate_x_1.mat'
VALIDATE_Y_PATH = '/work/gg0028/g260202/generate_data_3/validate_y_1.mat'

TEST_X_PATH = '/work/gg0028/g260202/generate_data_3/test_x_1.mat'
TEST_Y_PATH = '/work/gg0028/g260202/generate_data_3/test_y_1.mat'
...
# mi= 1
# path = '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/model_31_'+ str(mi) + '.pth'
# torch.save(model.state_dict(), path)
# torch.save(optimizer.state_dict(), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/optimizer_31_'+ str(mi) + '.pt')
# torch.save(scheduler.state_dict(), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/scheduler_31_'+ str(mi) + '.pt')
#
#
# ## save train loss
# torch.save(np.linspace(1, epochs, epochs).astype(int), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/epochs_31_'+ str(mi) + '.pt')
# torch.save(loss_train_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/loss_trian_f_31_'+ str(mi) + '.pt')
# torch.save(loss_validate_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/loss_validate_f_31_'+ str(mi) + '.pt')
# torch.save(loss_test_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_a_noise/results/loss_test_f_31_'+ str(mi) + '.pt')



mi= 1
path = '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/model_31_'+ str(mi) + '.pth'
torch.save(model.state_dict(), path)
torch.save(optimizer.state_dict(), '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/optimizer_31_'+ str(mi) + '.pt')
torch.save(scheduler.state_dict(), '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/scheduler_31_'+ str(mi) + '.pt')

## save train loss
torch.save(np.linspace(1, epochs, epochs).astype(int), '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/epochs_31_'+ str(mi) + '.pt')
torch.save(loss_train_f, '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/loss_trian_f_31_'+ str(mi) + '.pt')
torch.save(loss_validate_f, '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/loss_validate_f_31_'+ str(mi) + '.pt')
torch.save(loss_test_f, '/work/gg0028/g260202/escnn_rot/escnn_a_noise/results/loss_test_f_31_'+ str(mi) + '.pt')