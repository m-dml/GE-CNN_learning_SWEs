...
for i in range(8+8):
    ...
    ##########################
    ## escnn_noflux
    # '/home/yunfeihuang/Documents/INS/escnn_rot/escnn_noflux/plot/plot_good/u_'  no noise
    escnn_flux = torch.load(
        '/home/yunfeihuang/Documents/INS/escnn_rot/escnn_noflux_noise/plot/u_'
        + str(i_number[i]) + '.pt')
    ...
    axs[1, 0].set_title('rot_noflux', rotation=90, y=0.1, x=-0.1, pad=-14, color="purple")
    ...
    ## escnn_a
    escnn_a = torch.load(
        '/home/yunfeihuang/Documents/INS/escnn_rot/escnn_a/plot/plot_good/u_'
        + str(i_number[i]) + '.pt')
    ...
    ##########################
    ## escnn_flux
    # '/home/yunfeihuang/Documents/INS/escnn_rot/escnn_flux/plot/plot_good/u_'   no noise
    escnn_noflux = torch.load(
        '/home/yunfeihuang/Documents/INS/escnn_rot/escnn_flux_noise/plot/u_'
        + str(i_number[i]) + '.pt')
