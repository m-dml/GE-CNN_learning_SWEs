...
mi= 2
path = '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/model_12_'+ str(mi) + '.pth'
torch.save(model.state_dict(), path)
torch.save(optimizer.state_dict(), '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/optimizer_12_'+ str(mi) + '.pt')
torch.save(scheduler.state_dict(), '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/scheduler_12_'+ str(mi) + '.pt')


## save train loss
torch.save(np.linspace(1, epochs, epochs).astype(int), '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/epochs_12_'+ str(mi) + '.pt')
torch.save(loss_train_f, '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/loss_trian_f_12_'+ str(mi) + '.pt')
torch.save(loss_validate_f, '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/loss_validate_f_12_'+ str(mi) + '.pt')
torch.save(loss_test_f, '/p/project/hai_ml_pde/INS/Dilated_UNet/escnn_a_noise/results/loss_test_f_12_'+ str(mi) + '.pt')
