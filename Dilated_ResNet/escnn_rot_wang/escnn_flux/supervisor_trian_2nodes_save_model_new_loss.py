...
mi= 2
path = '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/model_31_'+ str(mi) + '.pth'
torch.save(model.state_dict(), path)
torch.save(optimizer.state_dict(), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/optimizer_31_'+ str(mi) + '.pt')
torch.save(scheduler.state_dict(), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/scheduler_31_'+ str(mi) + '.pt')


## save train loss
torch.save(np.linspace(1, epochs, epochs).astype(int), '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/epochs_31_'+ str(mi) + '.pt')
torch.save(loss_train_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/loss_trian_f_31_'+ str(mi) + '.pt')
torch.save(loss_validate_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/loss_validate_f_31_'+ str(mi) + '.pt')
torch.save(loss_test_f, '/p/project/hai_ml_pde/INS/escnn_rot/escnn_flux/results/loss_test_f_31_'+ str(mi) + '.pt')
